...
namespace OodleCoreSharp
{
    ...
    /// </summary>
    public partial class Oodle28 : IOodle
    {
        /// <summary>
        /// The library name used for resolution.
        /// </summary>
        private const string LibName = "oo2core_8";
        ...
        /// <summary>
        /// A singleton for <see cref="Oodle28"/>.
        /// </summary>
        private static readonly Oodle28 Instance = new();
        ...
        static unsafe Oodle28()
        {
            ...
            if (OodleInterop.IsLoaded())
            {
                ...
                {
                    OodleInterop.OodleInterop_Oodle28_SetPrint(pSetPrintf, &UnmanagedPrint);
                }
            }
        }
        ...
        /// <summary>
        /// Tries to load the Oodle8 library.
        /// </summary>
        /// <param name="oodle">An instance for accessing Oodle8 functions, or null.</param>
        /// <returns>Whether or not the library loaded.</returns>
        public static bool TryLoad([NotNullWhen(true)] out Oodle28? oodle)
        {
            if (Handle != nint.Zero)
            {
                oodle = Instance;
            ...
            if (Oodle.TryLoadCore(8, out nint handle))
            {
                Handle = handle;
                oodle = Instance;
                return true;

...
{
    /// <summary>
    /// Oodle major version 9.
    /// </summary>
    public partial class Oodle29 : IOodle
    {
        /// <summary>
        /// The library name used for resolution.
        /// </summary>
        private const string LibName = "oo2core_9";

        /// <summary>
        /// A handle to the Oodle8 library.
        /// </summary>
        private static nint Handle = Load();

        /// <summary>
        /// A singleton for <see cref="Oodle29"/>.
        /// </summary>
        private static readonly Oodle29 Instance = new();
        ...
        static unsafe Oodle29()
        {
            ...
            if (OodleInterop.IsLoaded())
            {
                ...
                {
                    OodleInterop.OodleInterop_Oodle29_SetPrint(pSetPrintf, &UnmanagedPrint);
                }
            }
        }
        ...
        /// <summary>
        /// Tries to load the Oodle9 library.
        /// </summary>
        /// <param name="oodle">An instance for accessing Oodle9 functions, or null.</param>
        /// <returns>Whether or not the library loaded.</returns>
        public static bool TryLoad([NotNullWhen(true)] out Oodle29? oodle)
        {
            if (Handle != nint.Zero)
            {
                oodle = Instance;
            ...
            if (Oodle.TryLoadCore(9, out nint handle))
            {
                Handle = handle;
                oodle = Instance;
                return true;

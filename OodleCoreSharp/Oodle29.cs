...
namespace OodleCoreSharp
{
    ...
    /// </summary>
    public partial class Oodle29 : IOodleCompressor
    {
        /// <summary>
        ...
        /// <returns>Size of compressed data written, or <see cref="OODLELZ_FAILED"/> for failure.</returns>
#if WINDOWS
        [LibraryImport("oo2core_9_win64.dll")]
        [UnmanagedCallConv(CallConvs = new Type[] { typeof(CallConvStdcall) })]
#elif OSX
        [LibraryImport("liboo2coremac64.2.9.dylib")]
        [UnmanagedCallConv(CallConvs = new Type[] { typeof(CallConvStdcall) })]
#elif LINUX
        [LibraryImport("liboo2corelinux64.so.9")]
        [UnmanagedCallConv(CallConvs = new Type[] { typeof(CallConvStdcall) })]
#endif
